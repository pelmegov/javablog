...
@SpringBootTest(classes = JavablogApp.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class FileUploadIntegrationTests {
	...
	public void shouldUploadFile() throws Exception {
		...
		ResponseEntity<String> response = this.restTemplate.postForEntity("/api", map,
				String.class);

		assertThat(response.getStatusCode()).isEqualByComparingTo(HttpStatus.FOUND);
		assertThat(response.getHeaders().getLocation().toString())
				.startsWith("http://localhost:" + this.port + "/api");
	...
	public void shouldDownloadFile() throws Exception {
		...
		assertThat(response.getBody()).isEqualTo("Хипстер!!!");
	}
